...
clickevents_sanitized_topic = app.topic("com.udacity.streams.clickevents.sanitized", key_type=str, value_type=ClickEventSanitized)
...
async def clickevent(clickevents):
    async for clickevent in clickevents:
        ...
        #
        await clickevents_sanitized_topic.send(key=clickeventsanitized.uri, value=clickeventsanitized)
